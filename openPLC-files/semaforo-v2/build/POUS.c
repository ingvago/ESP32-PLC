...
void SEMAFORO_init__(SEMAFORO *data__, BOOL retain) {
  __INIT_VAR(data__->ROJOC,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->AMARILLO,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->VERDEC,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->ROJOP,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->VERDEP,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->CONT1,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->CONT2,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->PARADA,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->DETENER,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->CAMBIO,__BOOL_LITERAL(FALSE),retain)
...
void SEMAFORO_body__(SEMAFORO *data__) {
  ...
  __SET_VAR(data__->,ROJOC,,(((!(__GET_VAR(data__->T3,)) && !(__GET_VAR(data__->T2,))) || ((__GET_VAR(data__->T3,) && __GET_VAR(data__->T2,)) && __GET_VAR(data__->T1,))) && !(__GET_VAR(data__->DETENER,))));
  __SET_VAR(data__->,AMARILLO,,((((!(__GET_VAR(data__->T3,)) && !(__GET_VAR(data__->T2,))) && (__GET_VAR(data__->T1,) || __GET_VAR(data__->T1,))) && !(__GET_VAR(data__->DETENER,))) || (((__GET_VAR(data__->T3,) && __GET_VAR(data__->T2,)) && __GET_VAR(data__->T1,)) && !(__GET_VAR(data__->DETENER,)))));
  __SET_VAR(data__->,VERDEC,,(((!(__GET_VAR(data__->T3,)) && __GET_VAR(data__->T2,)) && __GET_VAR(data__->T1,)) && !(__GET_VAR(data__->DETENER,))));
  __SET_VAR(data__->,ROJOP,,(((!(__GET_VAR(data__->T3,)) && __GET_VAR(data__->T1,)) || (__GET_VAR(data__->T2,) && __GET_VAR(data__->T1,))) && !(__GET_VAR(data__->DETENER,))));
  __SET_VAR(data__->,VERDEC,,(((!(__GET_VAR(data__->T3,)) && !(__GET_VAR(data__->T2,))) && !(__GET_VAR(data__->T1,))) && !(__GET_VAR(data__->DETENER,))));
  ...
  __SET_VAR(data__->,DETENER,,(!(__GET_VAR(data__->CAMBIO,)) && (__GET_VAR(data__->DETENER,) || __GET_VAR(data__->PARADA,))));
  __SET_VAR(data__->,CONMUTAR,,((!(__GET_VAR(data__->REBOOT,)) && __GET_VAR(data__->T2,)) && (__GET_VAR(data__->CONMUTAR,) || (!(__GET_VAR(data__->DETENER,)) && __GET_VAR(data__->CAMBIO,)))));
  __SET_VAR(data__->,CONT1,,!(__GET_VAR(data__->DETENER,)));
  __SET_VAR(data__->,CONT2,,!(__GET_VAR(data__->DETENER,)));
