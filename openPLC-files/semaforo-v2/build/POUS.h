...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,ROJOC)
  __DECLARE_VAR(BOOL,AMARILLO)
  __DECLARE_VAR(BOOL,VERDEC)
  __DECLARE_VAR(BOOL,ROJOP)
  __DECLARE_VAR(BOOL,VERDEP)
  __DECLARE_VAR(BOOL,CONT1)
  __DECLARE_VAR(BOOL,CONT2)
  __DECLARE_VAR(BOOL,PARADA)
  __DECLARE_VAR(BOOL,DETENER)
  __DECLARE_VAR(BOOL,CAMBIO)
